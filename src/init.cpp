...
{
    uiInterface.ThreadSafeMessageBox(str, _("666Coin"), CClientUIInterface::OK | CClientUIInterface::ICON_ETRKLAMATION | CClientUIInterface::MODAL);
    return true;
}
...
std::string HelpMessage()
{
    ...
    strUsage += "  -conf=<file>           " + _("Specify configuration file (default: 666Coin.conf)") + "\n";
    strUsage += "  -pid=<file>            " + _("Specify pid file (default: 666Coind.pid)") + "\n";
...
#define PROCESS_DEP_ENABLE 0x00000001
    ...
    if (filesystem::exists(GetDataDir() / "wallet.dat"))
    {
        ...
        if (r == CDBEnv::RECOVER_OK)
        {
            ...
            uiInterface.ThreadSafeMessageBox(msg, _("666Coin"), CClientUIInterface::OK | CClientUIInterface::ICON_ETRKLAMATION | CClientUIInterface::MODAL);
        }
